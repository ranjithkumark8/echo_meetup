        ...
        <div>
            <div className={Styles.header}>
                <div className={Styles.eventInfo_left}>
                    <Link to="/home"><img className={Styles.logo} src="https://secure.meetupstatic.com/s/img/5455565085016210254/logo/svg/logo--script.svg" alt="logo" height="70px" width="100px" /></Link>
