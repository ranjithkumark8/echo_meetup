...
const SignUpEmailForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const updatedSignUpData = {
            id : uuid(),
            img : "https://www.google.com/search?q=person+icons+images&client=firefox-b-d&tbm=isch&source=iu&ictx=1&fir=I9pklgvZUwwemM%252CmS7Rr4Njk7NZUM%252C_&vet=1&usg=AI4_-kQvgzfFMtxzktkUPkYdwpZjPbnRCw&sa=X&ved=2ahUKEwjUh8mfqc7uAhVNqksFHbmaBpMQ9QF6BAgSEAE#imgrc=I9pklgvZUwwemM",
            ...signupData
        }
    ...
    return (
        <div>
            ...
            <form className = {Styles.signup__form} onSubmit = {handleSubmit}>
                ...
                <br/>
                <input className = {Styles.signupform__input} type = "email" name = "emailAddress" value = {emailAddress} onChange = {handleChange} required/>
                <br/>
