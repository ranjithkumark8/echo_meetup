    ...
    return (
        <nav>
            <div className={styles.left}>
                <Link to="/home" className={styles.left__logo}>
            ...
            <div className={styles.actions}>
                <p onClick={handleNewEvent}>Start a new group</p>
                <BsChat className={styles.actions__icon} />
                <IoIosNotificationsOutline className={styles.actions__icon} />
                <div>
